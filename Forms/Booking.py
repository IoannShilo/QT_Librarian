...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_2.setMinimumSize(QSize(49, 0))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Reader ID", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"Book ID", None))
